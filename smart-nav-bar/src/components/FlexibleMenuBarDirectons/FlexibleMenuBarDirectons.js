...
import "./FlexibleMenuBarDirectons.scss";

const FlexibleMenuBarDirectons = () => {
  return (
    <div className="flexible-menubar-directons-container">
      <h2>
      ...
      <section className="main">
        <ol type="a">
          ...
          <li>
            ...
            about your thoughts in{" "}
            <code>
              <a href="https://github.com/nobi1007/react-components/issues/1">
                Issues
              </a>
            </code>{" "}
            section.
...
export default FlexibleMenuBarDirectons;
